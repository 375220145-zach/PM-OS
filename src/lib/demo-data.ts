...
const DEMO_PROJECTS: Project[] = [
     ...
     ============================================================ */
  {
    ...
    budget: [
      { category: 'mold', name: '外壳模具', estimated: 35000, actual: 32000 },
      { category: 'mold', name: '硅胶按键模具', estimated: 8000, actual: 7500 },
      { category: 'sample', name: '手板打样', estimated: 10000, actual: 9000 },
      { category: 'labor', name: '人力成本', estimated: 280000, actual: 270000 },
      { category: 'cert', name: 'FCC/CE 认证', estimated: 20000, actual: 18000 },
    ],
    createdAt: NANO_BASE,
     ...
     ============================================================ */
  {
    ...
    budget: [
      { category: 'mold', name: '外壳模具（上下壳）', estimated: 28000, actual: 28000 },
      { category: 'mold', name: '水贴模具', estimated: 3500, actual: 3200 },
      { category: 'sample', name: 'EVT/DVT 打样', estimated: 15000, actual: 12000 },
      { category: 'labor', name: '人力成本', estimated: 350000, actual: 340000 },
      { category: 'cert', name: 'FCC/CE/EMC 认证', estimated: 25000, actual: 20000 },
      { category: 'patent', name: '联名授权费', estimated: 100000, actual: 100000 },
      { category: 'travel', name: '工厂差旅', estimated: 8000, actual: 6000 },
    ],
...
const DEMO_BOM: BomItem[] = [
  /* Pocket Nano BOM */
  { id: 'demo-bom-nano-1', projectId: 'demo-nano', category: 'structure', name: '上壳', description: 'ABS 注塑 掌机形态外壳', isMold: true, quantity: 1, unitCost: 15, totalCost: 15, supplier: '供应商A' },
  { id: 'demo-bom-nano-2', projectId: 'demo-nano', category: 'structure', name: '底壳', description: 'ABS 注塑 含电池仓', isMold: true, quantity: 1, unitCost: 12, totalCost: 12, supplier: '供应商A' },
  { id: 'demo-bom-nano-3', projectId: 'demo-nano', category: 'structure', name: '硅胶按键', description: '导电硅胶按键组 12 键', isMold: true, quantity: 1, unitCost: 5, totalCost: 5, supplier: '供应商A' },
  { id: 'demo-bom-nano-4', projectId: 'demo-nano', category: 'hardware', name: 'PCBA 主板', description: '含 DSP 芯片 + 编解码器', isMold: false, quantity: 1, unitCost: 45, totalCost: 45, supplier: '供应商A' },
  { id: 'demo-bom-nano-5', projectId: 'demo-nano', category: 'hardware', name: 'LCD 屏幕', description: '28×28mm TFT 彩色屏', isMold: false, quantity: 1, unitCost: 18, totalCost: 18 },
  { id: 'demo-bom-nano-6', projectId: 'demo-nano', category: 'packaging', name: '彩盒', description: '单色印刷+哑膜 135×85×35mm', isMold: false, quantity: 1, unitCost: 5, totalCost: 5 },

  /* MIYAVI BOM */
  { id: 'demo-bom-miyavi-1', projectId: 'demo-miyavi', category: 'structure', name: '上壳（红）', description: '铝合金 喷砂150# 氧化 水贴 191×60×24mm', isMold: true, quantity: 1, unitCost: 45, totalCost: 45, supplier: '供应商A', notes: '喷砂+氧化+水贴三道工艺' },
  { id: 'demo-bom-miyavi-2', projectId: 'demo-miyavi', category: 'structure', name: '底壳（红）', description: '铝合金 喷砂150# 氧化 水贴 193×60×25mm', isMold: true, quantity: 1, unitCost: 45, totalCost: 45, supplier: '供应商A' },
  { id: 'demo-bom-miyavi-3', projectId: 'demo-miyavi', category: 'structure', name: '上壳（蓝）', description: '铝合金 喷砂150# 氧化 水贴 191×60×24mm', isMold: true, quantity: 1, unitCost: 45, totalCost: 45, supplier: '供应商A' },
  { id: 'demo-bom-miyavi-4', projectId: 'demo-miyavi', category: 'structure', name: '底壳（蓝）', description: '铝合金 喷砂150# 氧化 水贴 193×60×25mm', isMold: true, quantity: 1, unitCost: 45, totalCost: 45, supplier: '供应商A' },
  { id: 'demo-bom-miyavi-5', projectId: 'demo-miyavi', category: 'hardware', name: 'PCBA 组件（红）', description: '含踩钉螺母，6.35 螺母及对应垫片', isMold: false, quantity: 1, unitCost: 80, totalCost: 80, supplier: '供应商A' },
  { id: 'demo-bom-miyavi-6', projectId: 'demo-miyavi', category: 'hardware', name: 'PCBA 组件（蓝）', description: '含踩钉螺母，6.35 螺母及对应垫片', isMold: false, quantity: 1, unitCost: 80, totalCost: 80, supplier: '供应商A' },
  { id: 'demo-bom-miyavi-7', projectId: 'demo-miyavi', category: 'structure', name: '沉头螺丝', description: 'KM3×6×4.5 沉头 环保镀镍', isMold: false, quantity: 12, unitCost: 0.1, totalCost: 1.2 },
  { id: 'demo-bom-miyavi-8', projectId: 'demo-miyavi', category: 'structure', name: '内六角螺丝', description: 'TM3×6 内六角平圆头机螺钉 304 不锈钢', isMold: false, quantity: 4, unitCost: 0.2, totalCost: 0.8 },
  { id: 'demo-bom-miyavi-9', projectId: 'demo-miyavi', category: 'structure', name: '绝缘片', description: '黑色 PC 绝缘片防火材料 188×46.5×0.25mm', isMold: false, quantity: 2, unitCost: 0.3, totalCost: 0.6 },
  { id: 'demo-bom-miyavi-10', projectId: 'demo-miyavi', category: 'structure', name: '配重条', description: '镀锌板 150×14.5×2.5mm 22g', isMold: false, quantity: 2, unitCost: 1, totalCost: 2 },
  { id: 'demo-bom-miyavi-11', projectId: 'demo-miyavi', category: 'structure', name: '硅胶脚垫', description: '硅胶 12×2.5mm 黑色 单面背胶', isMold: false, quantity: 8, unitCost: 0.1, totalCost: 0.8 },
  { id: 'demo-bom-miyavi-12', projectId: 'demo-miyavi', category: 'structure', name: '旋钮硅胶套', description: '硅胶 8.5×6mm 黑色', isMold: false, quantity: 19, unitCost: 0.1, totalCost: 1.9 },
  { id: 'demo-bom-miyavi-13', projectId: 'demo-miyavi', category: 'packaging', name: '抽屉盒', description: '150g 银卡裱 1500g 双灰板 317×231×144mm 3C 印刷 逆向 UV', isMold: false, quantity: 1, unitCost: 25, totalCost: 25, supplier: '包装供应商' },
  { id: 'demo-bom-miyavi-14', projectId: 'demo-miyavi', category: 'packaging', name: '套装内托', description: '黑色 EVA 312×222×48mm 35kg/m³', isMold: false, quantity: 1, unitCost: 12, totalCost: 12, supplier: '包装供应商' },
  { id: 'demo-bom-miyavi-15', projectId: 'demo-miyavi', category: 'packaging', name: '英文铭牌', description: '哑银龙 PET 69×32mm 哑膜 高粘性', isMold: false, quantity: 1, unitCost: 0.5, totalCost: 0.5 },
];
